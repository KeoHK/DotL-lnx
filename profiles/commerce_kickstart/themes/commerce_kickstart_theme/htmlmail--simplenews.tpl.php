          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#FFF" style="font-family: verdana, arial, helvetica; font-size: 10px;">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family: verdana, arial, helvetica; font-size: 11px;">
                  <tr>
                    <td nowrap="nowrap" style="line-height: 1.6em;" valign="middle">
                      <div class="header">
							<div class="logo"><a href="http://www.dreamonthelake.it"><img src="http://lnx.dreamonthelake.it/profiles/commerce_kickstart/themes/commerce_kickstart_theme/images/email_header.jpg" alt="Congresso Nazionale Rotaract - Dream on the Lake" title="Congresso Nazionale Rotaract - Dream on the Lake" /></a></div>
					  </div>
                    </td>
                  </tr>
                </table>
            ...
            <tr>
              <td>
                <table>
                  <tr>
                    <td style="background: #EEE; color: #666; padding: 1em; font-size: 0.9em; line-height: 1.6em; border-top: #CCC 1px dotted; text-align: left;">
						<div style="margin-top:10px;">
							<div class="logo" style="float:right; margin-right:15%;">
